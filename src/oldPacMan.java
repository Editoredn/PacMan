...
//
//
//    // problem : ghost looks very small , bushes image change. it should be a square shaped tile
...
//
//        soundManager.playThemeMusic(1);
//        System.out.println("Current volume: " + soundManager.getVolume());
//
...
//                }
//            }
//            if(foods.remove(foodEaten)){
//                soundManager.playEatSound();// it removes that food  . note: it should not be placed inside the for loop as we are using for each loop. so any modifications we wanna made are to done outside it
//            }
...
//                resetPositions();
//                soundManager.playThemeMusic(currentLevel);
